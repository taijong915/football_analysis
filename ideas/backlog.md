...
- **남은 작업**: 블로그 발행. 스킬 적합성 검토(`blog/korea_qatar2022/ARC_MAP.md`)와 블로그용 그림(`processed/blog_*.png`)까지 끝났고, 다음은 스냅샷 처리 방식 결정 -> `blog-draft` 재작성이다. 체크리스트 정본은 `korea_qatar2022/PLAN.md`의 "블로그 발행" 절.
